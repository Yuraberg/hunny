---
title: "Гаплодиплоидия"
category: "Наука и стандарты"
excerpt: "Гаплодиплоидия (от греч. haploos — одиночный, простой и diploos — двойной) — это особая система определения пола у организмов, при которой самки развиваются из оплодотворённых (диплоидных) яиц, а с…"
draft: false
---

## Определение и общая характеристика

**Гаплодиплоидия** (от греч. *haploos* — одиночный, простой и *diploos* — двойной) — это особая система определения пола у организмов, при которой самки развиваются из оплодотворённых (диплоидных) яиц, а самцы — из неоплодотворённых (гаплоидных). Данный механизм представляет собой одну из форм [генетического определения пола](/wiki/geneticheskoe-opredelenie-pola), при которой пол особи детерминируется не наличием специфических половых хромосом, а плоидностью самого зиготного ядра.
...
Мелкие насекомые, среди которых встречаются виды с гаплодиплоидным определением пола, хотя у некоторых трипсов наблюдается [арренотокия](/wiki/arrenotokiya) (производство только самцов из неоплодотворённых яиц).
...
Самка после спаривания хранит сперму в [сперматеке](/wiki/spermateka) — специальном органе, соединённом с яйцеводом. При откладке яйца самка может контролировать выделение спермы на яйцо:
...
Эта асимметрия родства является ключевым фактором, объясняющим возникновение [эусоциальности](/wiki/eusotsialnost) у перепончатокрылых. Согласно [теории родственного отбора](/wiki/teoriya-rodstvennogo-otbora) Уильяма Гамильтона (1964), альтруистическое поведение эволюционно выгодно, если выполняется неравенство *r·B > C*, где *r* — коэффициент родства, *B* — выгода для реципиента, *C* — затраты для донора.
...
- Это усиливает эффекты [генетического дрейфа](/wiki/geneticheskiy-dreyf) и снижает эффективность отбора.
...
- В специальные "маточные" ячейки (более крупные, вертикальные) матка откладывает оплодотворённые яйца, личинки которых получают усиленное питание [маточным молочком](/wiki/matochnoe-molochko) — из них развиваются новые матки;
...
- У некоторых видов шмелей описаны случаи [телитокии](/wiki/terminologiya-telitokiya) — партеногенетического производства самок из неоплодотворённых яиц (например, у *Bombus terrestris* в некоторых популяциях).
