...
excerpt: "Крылья медоносной пчелы (Apis mellifera) представляют собой высокоспециализированные производные кутикулы, выполняющие критически важные функции в жизнедеятельности насекомого. Крыловой аппарат пче…"
draft: false
---
...
### Метаболические пути
- **Основной субстрат** — глюкоза, полученная из [мёда](/wiki/med) (содержащего около 70–80% сахаров) или нектара, который пчела несёт в зобике.
...
### Роль в опылении
- Крылья обеспечивают возможность перемещения между цветками, что является основой [опыления](/wiki/opylenie) энтомофильных растений.
...
- **Ориентационные полёты** — молодые пчёлы используют крылья для запоминания ландшафтных ориентиров, что критически важно для [танцевального языка](/wiki/tantsy-pchel) коммуникации.
...
- **Вентиляция улья** — пчёлы-вентиляторщицы машут крыльями для создания воздушного потока внутри улья, поддерживая оптимальный микроклимат (температура 34–36°C, влажность 50–70%) для выращивания расплода и переработки [нектара](/wiki/nektar) в мёд.

### Патологии и аномалии крыльев
- **Деформированное крыло** — вирус деформации крыла (DWV), передаваемый клещом [Varroa destructor](/wiki/varroa), вызывает недоразвитие крыльев, что делает пчёл неспособными к полёту.
...
### В апитерапии
- В [апитерапии](/wiki/apiterapiya) используются продукты пчеловодства, но не сами крылья; однако знание биохимии полёта важно для понимания качества мёда, поскольку энергетические затраты фуражиров влияют на состав и свойства [мёда](/wiki/med).
- Пыльца, собираемая пчёлами с помощью крыльев (электростатическое притяжение), является ценным продуктом — [пергой](/wiki/perga), богатой белками, витаминами и ферментами.
