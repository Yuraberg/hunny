...
excerpt: "Точное земледелие (прецизионное земледелие, англ. precision agriculture) — комплексная интегрированная система управления сельскохозяйственным производством, основанная на использовании современных…"
draft: false
---
...
2. **Коммерциализация (1990-е годы)** — выход на рынок первых коммерческих систем мониторинга урожайности, оснащённых датчиками массы зерна и влажности. Появление первых [ГИС-технологии](/wiki/gis-tehnologii) для сельскохозяйственных приложений.
...
4. **Цифровизация (с 2015 года)** — внедрение [Интернет вещей](/wiki/internet-veschey) (IoT), больших данных (Big Data), искусственного интеллекта и облачных платформ. Переход к полностью автоматизированным системам принятия решений.
...
- **Мультиспектральные сенсоры** — камеры, регистрирующие отражение в видимом и ближнем инфракрасном диапазонах для оценки состояния растительности (расчёт [Вегетационные индексы](/wiki/vegetatsionnye-indeksy));
...
- Пространственный анализ и интерполяцию ([Методы геостатистики](/wiki/metody-geostatistiki));
...
- Дифференцированная обработка гербицидами с учётом карт засорённости ([Фитосанитарный мониторинг](/wiki/fitosanitarnyy-monitoring)).
