---
title: "Фильтрация мёда"
category: "Сорта мёда"
excerpt: "Фильтрация мёда — это технологический процесс механического отделения твёрдых взвешенных частиц и коллоидных включений от жидкой фазы мёда с целью получения продукта заданной степени чистоты и проз…"
draft: false
---

## Определение и общая характеристика

**Фильтрация мёда** — это технологический процесс механического отделения твёрдых взвешенных частиц и коллоидных включений от жидкой фазы мёда с целью получения продукта заданной степени чистоты и прозрачности. В отличие от [процеживания](/wiki/protsezhivanie-meda), фильтрация предполагает прохождение мёда через фильтрующую среду с размерами пор, обеспечивающими задержание частиц менее 1 мм, включая микроскопические элементы.
...
- **Коллоидные частицы** (0,1–10 мкм): белково-азотистые соединения, коллоидный комплекс (включая [ингибиновый комплекс](/wiki/ingibin)), декстрины, ферментные комплексы.
...
- Инактивируются ферменты ([диастаза](/wiki/diastaza), [инвертаза](/wiki/invertaza), глюкозооксидаза);
...
7. **Контроль качества** — отбор проб для анализа на содержание [пыльцевых зёрен](/wiki/pyltsevye-zerna), диастазную активность, содержание ОМФ, микробиологические показатели.
