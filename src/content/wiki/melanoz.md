...
excerpt: "Меланоз (от греч. melas — чёрный, тёмный) — это инвазионное заболевание медоносных пчёл (Apis mellifera), вызываемое микроспоридией Nosema apis (Zander, 1909) и Nosema ceranae (Fries et al., 1996),…"
draft: false
---
...
- [Вирус деформации крыла](/wiki/virus-deformatsii-kryla)
- [Синдром разрушения пчелиных семей](/wiki/sindrom-razrusheniya-pchelinyh-semey)
