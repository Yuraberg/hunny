...
excerpt: "Трегалоза (от греч. τρέχω — «бежать», «двигаться»; систематическое название — α-D-глюкопиранозил-α-D-глюкопиранозид) — природный невосстанавливающий дисахарид, состоящий из двух остатков D-глюкозы,…"
draft: false
---
...
- [Дисахариды](/wiki/disaharidy)
- [Сахароза](/wiki/saharoza)
- [Гликозидная связь](/wiki/glikozidnaya-svyaz)
- [Криопротекторы](/wiki/krioprotektory)
- [Ангидробиоз](/wiki/angidrobioz)
- [Лиофилизация](/wiki/liofilizatsiya)
- [Аутофагия](/wiki/autofagiya)
- [Гликемический индекс](/wiki/glikemicheskiy-indeks)
- [Ферменты углеводного обмена](/wiki/fermenty-uglevodnogo-obmena)
- [Биостеклование](/wiki/biosteklovanie)
