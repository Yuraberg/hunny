...
category: "Термины"
excerpt: "Уксусная кислота (этановая кислота, химическая формула CH₃COOH) — слабая предельная одноосновная карбоновая кислота алифатического ряда. Является одной из важнейших органических кислот, широко расп…"
draft: false
---

**Уксусная кислота** (этановая кислота, химическая формула CH₃COOH) — слабая предельная одноосновная карбоновая кислота алифатического ряда. Является одной из важнейших органических кислот, широко распространённых в природе и играющих ключевую роль в [Метаболизм пчёл](/wiki/metabolizm-pchel) и [Биохимия мёда](/wiki/biohimiya-meda). В чистом виде (ледяная уксусная кислота) представляет собой бесцветную гигроскопичную жидкость с резким характерным запахом и кислым вкусом.
...
Уксуснокислое брожение этанола ([Брожение](/wiki/brozhenie)) с использованием бактерий рода *Acetobacter*:
...
### Природные источники
Уксусная кислота содержится в нектаре многих медоносных растений, а также образуется в процессе ферментативного разложения углеводов в [Пчелиный мёд](/wiki/pchelinyy-med). Концентрация уксусной кислоты в мёде варьирует от 0,01% до 0,3% и увеличивается при длительном хранении или порче продукта.

### Метаболическая функция
В организме медоносной пчёлы (*Apis mellifera*) уксусная кислота играет важную роль в [Цикл лимонной кислоты](/wiki/tsikl-limonnoy-kisloty) как предшественник ацетил-кофермента А. Она участвует в:

- **Липогенезе** — синтезе жирных кислот, необходимых для формирования [Воск](/wiki/vosk)а
...
- Повышению устойчивости к [Нозематоз](/wiki/nozematoz)
...
### Диастазное число
Повышенное содержание уксусной кислоты (выше 0,15%) коррелирует со снижением [Диастазное число мёда](/wiki/diastaznoe-chislo-meda), что свидетельствует о нарушении ферментативного баланса продукта.
...
Уксусная и [Глюконовая кислота](/wiki/glyukonovaya-kislota) совместно определяют общую кислотность мёда. Их соотношение влияет на активность каталазы и пероксидазы — ферментов, ответственных за антиоксидантные свойства продукта.

### Влияние на ингибин
Ингибин — антибактериальный фактор мёда, активность которого зависит от pH среды. Уксусная кислота, снижая pH, усиливает антимикробное действие ингибина, что особенно важно для [Противогнильцовая активность мёда](/wiki/protivogniltsovaya-aktivnost-meda).
