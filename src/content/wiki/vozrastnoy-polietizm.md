---
title: "Возрастной полиэтизм"
category: "Анатомия и физиология"
excerpt: "Возрастной полиэтизм (от греч. polys — многий и ethos — обычай, нрав; в апиологии — от polys и etos — год) — это закономерное, генетически детерминированное изменение комплекса поведенческих, физио…"
draft: false
---
...
В отличие от [Кастовый полиэтизм](/wiki/kastovyy-polietizm), где разделение труда обусловлено морфологическими различиями между маткой, трутнями и рабочими особями, возрастной полиэтизм описывает временную динамику внутри одной касты — рабочих пчёл.
...
В 1950-х годах М. Линдауэр и Б. Хёльдоблер уточнили механизмы, связывающие возрастные изменения с социальным окружением. Современные исследования (Дж. Робинсон, 1990-е — 2000-е) выявили генетическую и эпигенетическую регуляцию возрастного полиэтизма, включая роль [Ювенильный гормон](/wiki/yuvenilnyy-gormon) и [Феромоны расплода](/wiki/feromony-rasploda).
...
- **Сбор нектара** — пчела совершает вылеты на медоносные растения, используя [Танцы пчёл](/wiki/tantsy-pchel) для передачи информации о координатах источника корма другим особям.
...
3. **Эффективную коммуникацию** — только пчёлы, достигшие стадии фуражира, способны к выполнению [Танцы пчёл](/wiki/tantsy-pchel), что требует развитой нервной системы и накопленного опыта.
...
При воздействии некоторых пестицидов (неоникотиноиды) наблюдается нарушение перехода к фуражировке: пчёлы теряют способность к навигации и не возвращаются в улей. Это приводит к коллапсу семьи ([Синдром разрушения пчелиных семей](/wiki/sindrom-razrusheniya-pchelinyh-semey)).
...
Заражение клещом *Varroa destructor* ([Варроатоз](/wiki/varroatoz)) и вирусными инфекциями (вирус деформации крыла) приводит к ускоренному старению пчёл, снижению эффективности выполнения функций на всех стадиях.
...
- [Кастовый полиэтизм](/wiki/kastovyy-polietizm)
- [Танцы пчёл](/wiki/tantsy-pchel)
- [Ювенильный гормон](/wiki/yuvenilnyy-gormon)
- [Феромоны расплода](/wiki/feromony-rasploda)
