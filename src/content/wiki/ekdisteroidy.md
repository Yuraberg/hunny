...
excerpt: "Экдистероиды (от греч. ekdysis — линька) — класс полигидроксилированных стероидных соединений, выполняющих в организме членистоногих и ряда других беспозвоночных функции гормонов линьки, метаморфоз…"
draft: false
---
...
- [Ювенильные гормоны](/wiki/yuvenilnye-gormony)
- [Стероидные гормоны](/wiki/steroidnye-gormony)
- [Рецептор экдизона](/wiki/retseptor-ekdizona)
- [Фитоэкдистероиды](/wiki/fitoekdisteroidy)
- [Линька членистоногих](/wiki/linka-chlenistonogih)
- [Метаболизм стероидов](/wiki/metabolizm-steroidov)
- [Адаптогены](/wiki/adaptogeny)
