...
excerpt: "Экдизоны (от греч. ekdysis — линька) — стероидные гормоны насекомых и других членистоногих, регулирующие процессы линьки, метаморфоза и репродукции. Относятся к группе полигидроксилированных стерои…"
draft: false
---
...
- [Проторацикотропный гормон](/wiki/protoratsikotropnyy-gormon)
- [Метаморфоз насекомых](/wiki/metamorfoz-nasekomyh)
