...
excerpt: "Целлюлоза (от лат. cellula — клетка), также известная как клетчатка, — это линейный полисахарид, состоящий из остатков β-D-глюкопиранозы, соединённых β-(1→4)-гликозидными связями. Химическая формул…"
draft: false
---
