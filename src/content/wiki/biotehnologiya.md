...
excerpt: "Биотехнология — междисциплинарная область науки и производства, основанная на использовании живых организмов, биологических систем и биологических процессов для получения практически значимых проду…"
draft: false
---
...
В современном понимании биотехнология объединяет достижения [Молекулярная биология](/wiki/molekulyarnaya-biologiya), [Генетика](/wiki/genetika), [Микробиология](/wiki/mikrobiologiya), [Биохимия](/wiki/biohimiya) и [Биоинженерия](/wiki/bioinzheneriya) с инженерными подходами для создания технологических процессов, воспроизводящих или модифицирующих естественные биологические механизмы.
...
- **Современная (новая) биотехнология** — методы [Генная инженерия](/wiki/gennaya-inzheneriya), [Протеомика](/wiki/proteomika), [Метаболомика](/wiki/metabolomika), [Синтетическая биология](/wiki/sinteticheskaya-biologiya).
...
- **1897 год** — Эдуард Бюхнер обнаружил, что ферментация может происходить в бесклеточных экстрактах дрожжей, заложив основы [Энзимология](/wiki/enzimologiya).
...
- **1953 год** — Джеймс Уотсон и Фрэнсис Крик расшифровали структуру [ДНК](/wiki/dnk), создав теоретическую основу для генетической инженерии.

### Эпоха генной инженерии (1970-е — настоящее время)

- **1972 год** — Пол Берг создал первую рекомбинантную молекулу ДНК.
- **1973 год** — Стэнли Коэн и Герберт Бойер разработали метод [Клонирование генов](/wiki/klonirovanie-genov).
...
- **2012 год** — разработка системы [CRISPR/Cas9](/wiki/crispr-cas9) для редактирования геномов.
...
- Редактирование генома с использованием [Нуклеазы с «цинковыми пальцами»](/wiki/nukleazy-s-tsinkovymi-paltsami), [TALEN](/wiki/talen) и [CRISPR/Cas9](/wiki/crispr-cas9).
