---
title: "Жалящий аппарат"
category: "Пчёлы и породы"
excerpt: "Жалящий аппарат медоносной пчелы (Apis mellifera) представляет собой сложную эволюционно модифицированную структуру, происходящую из яйцеклада самки. У рабочей пчелы и матки он выполняет защитную ф…"
draft: false
---
...
- [Мёд](/wiki/med) — продукт, ради защиты которого эволюционировал жалящий аппарат.
- [Перга](/wiki/perga) — белковый корм, привлекающий хищников и требующий защиты.
- [Апитерапия](/wiki/apiterapiya) — медицинское применение пчелиного яда.
- [Пчелиный яд](/wiki/pchelinyy-yad) — биохимический продукт жалящего аппарата.
- [Феромоны пчел](/wiki/feromony-pchel) — сигнальные молекулы, регулирующие защитное поведение.
- [Пчелиная семья](/wiki/pchelinaya-semya) — суперорганизм, в котором жалящий аппарат выполняет коллективную защитную функцию.
- [Матка](/wiki/matka) — особь с модифицированным жалящим аппаратом.
- [Трутень](/wiki/truten) — особь без жалящего аппарата.
- [Породы пчел](/wiki/porody-pchel) — генетические вариации агрессивности и морфологии жала.
