...
excerpt: "Реология мёда — раздел физики и пищевой инженерии, изучающий закономерности деформации и течения мёда под воздействием внешних механических напряжений. Будучи концентрированным водным раствором сах…"
draft: false
---
...
- [Вязкость](/wiki/vyazkost) — фундаментальное понятие, определяющее внутреннее трение в жидкости.
- [Тиксотропия](/wiki/tiksotropiya) — обратимый процесс разрушения структуры при сдвиге.
- [Псевдопластичность](/wiki/psevdoplastichnost) — снижение вязкости с ростом скорости сдвига.
- [Кристаллизация мёда](/wiki/kristallizatsiya-meda) — фазовый переход, радикально меняющий реологические свойства.
- [Диастазное число](/wiki/diastaznoe-chislo) — показатель ферментативной активности, коррелирующий с термической историей и, косвенно, с реологией.
- [Гигроскопичность](/wiki/gigroskopichnost) — способность поглощать влагу, влияющая на вязкость при хранении.
- [Падевый мёд](/wiki/padevyy-med) — сорт с повышенным содержанием декстринов, отличающийся аномальной реологией.
