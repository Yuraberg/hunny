---
title: "Феромоны рабочих пчёл"
category: "Анатомия и физиология"
excerpt: "Феромоны рабочих пчёл — это совокупность биологически активных летучих соединений, выделяемых рабочими особями Apis mellifera во внешнюю среду и вызывающих специфические поведенческие или физиологи…"
draft: false
---

## Определение и общая характеристика

**Феромоны рабочих пчёл** — это совокупность биологически активных летучих соединений, выделяемых рабочими особями *Apis mellifera* во внешнюю среду и вызывающих специфические поведенческие или физиологические реакции у других членов колонии. Термин происходит от греческих слов *pherein* (переносить) и *horman* (возбуждать), что отражает их сигнальную функцию в организации [гнезда](/wiki/gnezdo-medonosnoy-pchely).

Рабочие пчёлы, составляющие основную массу популяции улья, продуцируют комплекс феромонов, регулирующих практически все аспекты внутригнездовой жизни: от координации фуражировки до защиты от хищников. В отличие от [феромонов матки](/wiki/feromony-matki), которые действуют преимущественно на репродуктивную физиологию, феромоны рабочих ориентированы на оперативное управление поведением и поддержание гомеостаза колонии.
...
|-----------------|---------|----------|
| Терпены | гераниол, цитраль | [железа Насонова](/wiki/nazonova-zheleza) |
| Кетоны | 2-гептанон | [мандибулярные железы](/wiki/mandibulyarnye-zhelezy) |
| Сложные эфиры | изоамилацетат | [железа Кожевникова](/wiki/zheleza-kozhevnikova) |
| Спирты | 2-октанол | различные железы |
| Альдегиды | нонаналь | [Железа Насонова](/wiki/zheleza-nasonova) |
...
**Функции**: 
- Маркировка лёта при [роении](/wiki/roenie-pchel)
- Привлечение фуражиров к источнику корма
- Координация при [ориентации](/wiki/orientatsiya-pchel)
...
- Репеллентное действие на [врагов](/wiki/pchelinyy-volk)
...
**Функции**:
- Инициация [гигиенического поведения](/wiki/gigienicheskoe-povedenie-pchel)
...
Аларм-феромоны усиливают действие [жалящего аппарата](/wiki/zhalo-pchely): пчела, ужалившая жертву, выделяет феромон, который привлекает других пчёл к месту ужаления. Это создаёт положительную обратную связь, обеспечивающую массированную защиту колонии.
...
3. Стимулирует [мобилизацию](/wiki/rekrutirovanie-pchel) новых фуражиров
...
При выполнении [виляющего танца](/wiki/tanets-pchel) рабочая пчела выделяет феромоны Насонова, создавая химический "шлейф", который помогает другим пчёлам:
...
- **Свободные жирные кислоты** — модулируют активность [гипофарингеальных желёз](/wiki/gipofaringealnye-zhelezy)
...
- Поддерживает [репродуктивную изоляцию](/wiki/reproduktivnaya-izolyatsiya-kast) каст
...
- [американскому гнильцу](/wiki/amerikanskiy-gnilets)
- [европейскому гнильцу](/wiki/evropeyskiy-gnilets)
- [варроатозу](/wiki/varroatoz)
...
- **[Варроа-клещ](/wiki/varroa-klesch)** ориентируется на 2-гептанон при поиске хозяина
...
- **Гормональным статусом** ([ювенильный гормон](/wiki/yuvenilnyy-gormon))
