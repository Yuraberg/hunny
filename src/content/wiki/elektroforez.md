...
excerpt: "Электрофорез (от греч. ēlektron — янтарь и phoresis — перенесение) — это физико-химический процесс направленного движения заряженных коллоидных частиц или макромолекул в жидкой или гелеобразной сре…"
draft: false
---
...
Метод занимает фундаментальное положение в [биохимии](/wiki/biohimiya), [молекулярной биологии](/wiki/molekulyarnaya-biologiya), [генетике](/wiki/genetika) и клинической диагностике, являясь «золотым стандартом» для анализа макромолекулярных смесей.
...
- **Анализ фрагментов ДНК** после рестрикции или ПЦР ([ПЦР](/wiki/polimeraznaya-tsepnaya-reaktsiya)): определение размеров, количественная оценка.
...
- **Блоттинговыми методами** — [вестерн-блот](/wiki/vestern-blotting), Саузерн-блот, Нозерн-блот.
