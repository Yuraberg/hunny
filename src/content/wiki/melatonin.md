...
excerpt: "Мелатонин (N-ацетил-5-метокситриптамин) — полифункциональный регуляторный гормон, синтезируемый преимущественно эпифизом (шишковидным телом) из аминокислоты триптофана. У млекопитающих и человека я…"
draft: false
---
...
- 1958 год — американский дерматолог [Аарон Лернер](/wiki/aaron-lerner) из Йельского университета выделил из 250 000 бычьих эпифизов кристаллическое вещество, ответственное за этот эффект, и назвал его мелатонином (от греч. *melas* — чёрный + *tonos* — напряжение).

### 1.2. Современный этап
- 1960-е годы — исследование ферментов синтеза: [гидроксииндол-О-метилтрансфераза](/wiki/gidroksiindol-o-metiltransferaza) (ГИОМТ) и [серотонин-N-ацетилтрансфераза](/wiki/serotonin-n-atsetiltransferaza) (СНАТ).
...
- **Синхронизация циркадианных ритмов**: мелатонин передаёт сигнал "темноты" в СХЯ, модулируя экспрессию часовых генов ([Clock](/wiki/clock), [Bmal1](/wiki/bmal1), [Per](/wiki/per), [Cry](/wiki/cry)).
