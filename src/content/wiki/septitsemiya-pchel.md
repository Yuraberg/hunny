---
title: "Септицемия пчёл"
category: "Болезни и вредители"
excerpt: "Септицемия пчёл (лат. Septicaemia apium) — это тяжелое инфекционное заболевание взрослых особей медоносной пчелы (Apis mellifera), вызываемое бактериями рода Pseudomonas (преимущественно Pseudomona…"
draft: false
---
...
- Контаминированные [ульи](/wiki/uley) и соты
- Почва и растительные остатки (Pseudomonas — типичный почвенный микроорганизм)
- Вода из загрязнённых водоёмов

### Пути передачи

1. **Алиментарный** — при потреблении загрязнённого [мёда](/wiki/med), [перги](/wiki/perga) или воды
...
- **Ослабление семей** после [нозематоза](/wiki/nozematoz), [акарапидоза](/wiki/akarapidoz) или вирусных инфекций
...
После преодоления кишечного барьера (при нарушении целостности эпителия средней кишки) бактерии попадают в гемоцель, где происходит их активное размножение в [гемолимфе](/wiki/gemolimfa). Инкубационный период составляет 24–72 часа при температуре 25–30°C.
...
- [Аспергиллёза](/wiki/aspergillez) (поражение грибами Aspergillus)
- [Острого паралича пчёл](/wiki/paralich-pchel) (вирусная этиология)
- [Сальмонеллёза](/wiki/salmonellez-pchel) (возбудитель Salmonella enteritidis)
- Отравлений пестицидами (токсикозы)
- [Гафниоза](/wiki/gafnioz) (возбудитель Hafnia alvei)
...
- **Фторхинолоны** (энрофлоксацин) — 100 мг на 1 литр сиропа (с осторожностью, возможна кумуляция в [мёде](/wiki/med))
...
1. **Санитарное состояние пасеки**:
   - Регулярная очистка и дезинфекция [ульев](/wiki/uley)
...
3. **Кормление**:
   - Полноценное белковое питание (наличие достаточного количества [перги](/wiki/perga))
...
- Снижения продуктивности ослабленных семей (уменьшение сбора [мёда](/wiki/med) на 30–50%)
...
- [Нозематоз](/wiki/nozematoz) — нарушение кишечного эпителия облегчает проникновение возбудителя
- [Вирусные инфекции](/wiki/virusnye-bolezni-pchel) — иммуносупрессия способствует активации латентной инфекции
- [Акарапидоз](/wiki/akarapidoz) — повреждение трахейной системы создаёт входные ворота для инфекции
- [Варроатоз](/wiki/varroatoz) — стрессовый фактор и вектор возможной передачи
...
- [Аспергиллёз](/wiki/aspergillez)
- [Апитерапия](/wiki/apiterapiya)
- [Варроатоз](/wiki/varroatoz)
- [Паралич пчёл](/wiki/paralich-pchel)
- [Сальмонеллёз пчёл](/wiki/salmonellez-pchel)
- [Гафниоз](/wiki/gafnioz)
