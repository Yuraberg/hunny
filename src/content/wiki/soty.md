...
- **Субстрат**: Для синтеза 1 кг воска пчёлам необходимо потребить около 3,5–4 кг [мёда](/wiki/med) (приблизительно 8 кг нектара в пересчёте на сырьё). Это связано с тем, что синтез липидов из углеводов — анаболический процесс, требующий значительных затрат энергии в форме АТФ.
...
Соты и продукты их переработки широко используются в [апитерапии](/wiki/apiterapiya):
...
- **Сотовый мёд**: Мёд в сотах ([Сотовый мёд](/wiki/sotovyy-med)) сохраняет все биологически активные вещества (ферменты, витамины, флавоноиды) в нативном состоянии, так как не подвергается нагреванию и фильтрации. Воск сота содержит прополис, который дополнительно консервирует мёд.
...
- **Акарициды** (кумафос, флувалинат, амитраз), применяемые для борьбы с [варроатозом](/wiki/varroatoz), накапливаются в воске и оказывают хроническое токсическое действие на расплод.
