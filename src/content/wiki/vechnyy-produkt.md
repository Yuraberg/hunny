---
title: "Вечный продукт"
category: "Пчеловодство"
excerpt: "Вечный продукт — эмпирическое и научно обоснованное обозначение мёда как субстанции, обладающей практически неограниченным сроком хранения при соблюдении определённых условий."
draft: false
---

## Определение и феномен

- **Вечный продукт** — эмпирическое и научно обоснованное обозначение [мёда](/wiki/med) как субстанции, обладающей практически неограниченным сроком хранения при соблюдении определённых условий.
...
- Главный термолабильный антимикробный агент мёда — **перекись водорода (H₂O₂)**, генерируемая ферментом [глюкозооксидазой](/wiki/glyukozooksidaza) (GOx), который пчёлы добавляют в нектар.
...
- Признаки ферментации: пузырьки газа, кислый запах, пена на поверхности — такой мёд непригоден к употреблению, но может быть использован для приготовления медовухи ([Медовуха](/wiki/medovuha)).
...
## Значение для [апитерапии](/wiki/apiterapiya) и пищевой промышленности
