...
excerpt: "Аминокислоты (синоним: аминокарбоновые кислоты) — класс органических соединений, молекулы которых содержат одновременно карбоксильную группу (−COOH) и аминогруппу (−NH₂). В природе встречается боле…"
draft: false
---

## Определение и фундаментальное значение

**Аминокислоты** (синоним: аминокарбоновые кислоты) — класс органических соединений, молекулы которых содержат одновременно карбоксильную группу (−COOH) и аминогруппу (−NH₂). В природе встречается более 500 различных аминокислот, однако лишь 20 из них (протеиногенные) являются мономерными звеньями [Белки](/wiki/belki) всех живых организмов на Земле.
...
- **β-аминокислоты** — аминогруппа расположена у β-углерода (например, β-аланин, входящий в состав [Коэнзим A](/wiki/koenzim-a)).
- **γ-аминокислоты** — аминогруппа у γ-углерода (γ-аминомасляная кислота, ГАМК — важнейший тормозной [Нейромедиаторы](/wiki/neyromediatory)).
...
### Стереоизомерия
Все α-аминокислоты, за исключением глицина, содержат хиральный α-углеродный атом и существуют в виде двух оптических изомеров: L- и D-форм. В составе [Белки](/wiki/belki) входят исключительно L-изомеры. D-аминокислоты встречаются в природе реже — в клеточных стенках бактерий ([Пептидогликан](/wiki/peptidoglikan)), в составе некоторых [Антибиотики](/wiki/antibiotiki) (например, [Грамицидин](/wiki/gramitsidin)).

### Кислотно-основные свойства
Аминокислоты проявляют свойства слабых кислот и слабых оснований. Изоэлектрическая точка (pI) — значение pH, при котором молекула электронейтральна. Для нейтральных аминокислот pI ≈ 5,5–6,3; для кислых — 2,8–3,2; для основных — 7,6–10,8. Это свойство используется в [Электрофорез](/wiki/elektroforez) и [Ионообменная хроматография](/wiki/ionoobmennaya-hromatografiya) для разделения аминокислот.

### Реакционная способность
- **Реакция с нингидрином** — качественная реакция, дающая фиолетовое окрашивание (используется в [Хроматография](/wiki/hromatografiya) и автоматических анализаторах).
- **Дезаминирование** — отщепление аминогруппы с образованием кетокислот (ключевой этап [Катаболизм аминокислот](/wiki/katabolizm-aminokislot)).
- **Декарбоксилирование** — отщепление CO₂ с образованием биогенных аминов ([Гистамин](/wiki/gistamin), [Серотонин](/wiki/serotonin), [ГАМК](/wiki/gamk)).
...
- **Трансаминирование** — перенос аминогруппы с аминокислоты на α-кетокислоту при участии [Трансаминазы](/wiki/transaminazy) и кофермента [Пиридоксальфосфат](/wiki/piridoksalfosfat) (витамин B₆). Этот процесс является основным путём синтеза заменимых аминокислот.
- **Восстановительное аминирование** — прямое включение аммиака в α-кетоглутарат с образованием глутамата (реакция катализируется [Глутаматдегидрогеназа](/wiki/glutamatdegidrogenaza)).
- **Метаболические предшественники**:
  - Глицин, серин, цистеин — из 3-фосфоглицерата (промежуточный продукт [Гликолиз](/wiki/glikoliz)).
  - Аланин, аспартат, аспарагин, глутамат, глутамин, пролин, аргинин — из пирувата и интермедиатов [Цикл Кребса](/wiki/tsikl-krebsa).
...
3. **Орнитиновый цикл** ([Цикл мочевины](/wiki/tsikl-mocheviny)) — в печени происходит превращение аммиака в мочевину (по 2 атома азота на молекулу). Ключевые ферменты: [Карбамоилфосфатсинтетаза I](/wiki/karbamoilfosfatsintetaza-i), [Орнитинтранскарбамоилаза](/wiki/ornitintranskarbamoilaza), [Аргиназа](/wiki/arginaza).
...
- **Фенилаланин** → тирозин → фумарат + ацетоацетат. Нарушение этого пути приводит к [Фенилкетонурия](/wiki/fenilketonuriya) — наследственному заболеванию (дефицит фенилаланингидроксилазы).
- **Триптофан** → кинурениновый путь → никотиновая кислота (предшественник [НАД⁺](/wiki/nad)).
- **Гистидин** → гистамин (через гистидиндекарбоксилазу) → урокановая кислота → глутамат.

## Биологические функции

### Строительная функция
Аминокислоты являются мономерами [Белки](/wiki/belki) — главного структурного и функционального материала клеток. Полипептидные цепи формируются путём образования пептидных связей между α-карбоксильной и α-аминогруппами соседних аминокислот. Последовательность аминокислот (первичная структура) определяет все уровни организации белка: вторичную (α-спирали, β-складчатые слои), третичную и четвертичную структуры.

### Регуляторная функция
- **Предшественники биогенных аминов**:
  - Триптофан → [Серотонин](/wiki/serotonin) → [Мелатонин](/wiki/melatonin).
  - Тирозин → [Дофамин](/wiki/dofamin) → [Норадреналин](/wiki/noradrenalin) → [Адреналин](/wiki/adrenalin); также тирозин → тироксин ([Гормоны щитовидной железы](/wiki/gormony-schitovidnoy-zhelezy)).
  - Гистидин → [Гистамин](/wiki/gistamin).
  - Глутамат → [ГАМК](/wiki/gamk).
  - Глицин (сам является нейромедиатором).
- **Синтез [Гем](/wiki/gem)**: глицин + сукцинил-КоА → δ-аминолевулиновая кислота (первый этап порфиринового пути).
...
- **ВСАА** ([Разветвлённые аминокислоты](/wiki/razvetvlennye-aminokisloty): валин, лейцин, изолейцин) — стимулируют синтез мышечного белка.
- **Глутамин** — поддержка иммунной функции и восстановление кишечного эпителия.
- **Аргинин** — предшественник [Оксид азота (NO)](/wiki/oksid-azota-no), вазодилатация.
...
- Скрининга наследственных метаболических заболеваний ([Тандемная масс-спектрометрия](/wiki/tandemnaya-mass-spektrometriya)).
