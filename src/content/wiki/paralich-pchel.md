...
excerpt: "Паралич пчёл (лат. Paralysis apium; англ. Bee paralysis, Honey bee paralysis) — это инфекционное вирусное заболевание взрослых особей медоносной пчелы (Apis mellifera), характеризующееся прогрессир…"
draft: false
---
...
- Исключение сходных заболеваний: [Нозематоз](/wiki/nozematoz), [Акарапидоз](/wiki/akarapidoz), отравления пестицидами, нарушения кормления.
...
- **[Септицемия пчёл](/wiki/septitsemiya-pchel)** — бактериальное заболевание, сопровождающееся размягчением тканей и характерным запахом;
- **[Акарапидоз](/wiki/akarapidoz)** — поражение трахей клещом *Acarapis woodi*, при котором наблюдается «раскрылица»;
