...
excerpt: "Апомиксис (от греч. ἀπό — «без» и μῖξις — «смешение») — форма бесполого размножения у цветковых растений, при которой образование зародыша происходит без слияния мужских и женских гамет. В широком …"
draft: false
---
...
В отличие от [амфимиксиса](/wiki/amfimiksis), при апомиксисе нарушается или полностью исключается мейоз, а также процессы [двойного оплодотворения](/wiki/dvoynoe-oplodotvorenie), характерные для покрытосеменных. Апомиксис встречается примерно у 1–2% видов цветковых растений, однако его распространённость в пределах отдельных таксонов может быть значительно выше.
...
Не следует путать апомиксис с [партенокарпией](/wiki/partenokarpiya) — развитием плода без оплодотворения и без образования семян. При партенокарпии зародыш не формируется, тогда как апомиксис всегда связан с образованием жизнеспособных семян.
