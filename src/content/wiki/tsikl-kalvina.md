...
1. **Восстановительный эквивалент** — НАДФН, образующийся в [световой фазе](/wiki/svetovaya-faza-fotosinteza).
...
4. **Температурный оптимум** — обычно 25–30 °C для C3-растений; при повышении температуры возрастает конкуренция CO₂ и O₂ на активном центре Рубиско, что приводит к усилению [фотодыхания](/wiki/fotodyhanie).
...
**Побочная реакция оксигенации**: Рубиско также катализирует присоединение O₂ к RuBP, что даёт одну молекулу 3-ФГК и одну молекулу 2-фосфогликолата. Последний метаболизируется в ходе [фотодыхания](/wiki/fotodyhanie) с потерей CO₂ и затратами энергии. Это явление снижает эффективность фотосинтеза у C3-растений.
...
- **[Фотодыхание](/wiki/fotodyhanie)**: при оксигенации RuBP образуется 2-фосфогликолат, который метаболизируется в пероксисомах и митохондриях с образованием глицина и серина, возвращая часть углерода в цикл в виде 3-ФГК.
- **[Пентозофосфатный путь](/wiki/pentozofosfatnyy-put)** (окислительная ветвь): в цитозоле и пластидах существует окислительный пентозофосфатный путь, который может конвертировать гексозофосфаты в пентозофосфаты для нуклеотидного синтеза, однако в хлоропластах доминирует именно восстановительный цикл.
...
- [Световая фаза фотосинтеза](/wiki/svetovaya-faza-fotosinteza)
- [Рубиско](/wiki/rubisko)
- [Фотодыхание](/wiki/fotodyhanie)
- [C4-фотосинтез](/wiki/c4-fotosintez)
- [CAM-фотосинтез](/wiki/cam-fotosintez)
- [Хлоропласт](/wiki/hloroplast)
- [Тиоредоксин](/wiki/tioredoksin)
- [Ферредоксин](/wiki/ferredoksin)
- [Пентозофосфатный путь](/wiki/pentozofosfatnyy-put)
- [Глюконеогенез](/wiki/glyukoneogenez)
