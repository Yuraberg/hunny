...
excerpt: "Гистамин (от греч. histos — ткань; систематическое наименование: 2-(4-имидазолил)этиламин; молекулярная формула C₅H₉N₃; молекулярная масса 111,15 Да) — биогенный амин, производное аминокислоты Гист…"
draft: false
---

## Определение и общая характеристика

**Гистамин** (от греч. *histos* — ткань; систематическое наименование: 2-(4-имидазолил)этиламин; молекулярная формула C₅H₉N₃; молекулярная масса 111,15 Да) — биогенный амин, производное аминокислоты [Гистидин](/wiki/gistidin) (L-α-амино-β-имидазолпропионовая кислота). Относится к группе [Биогенные амины](/wiki/biogennye-aminy), выполняет роль тканевого гормона, нейромедиатора и иммуномодулятора. Впервые синтезирован немецким химиком Адольфом Виндаусом в 1907 году, физиологическая роль установлена Генри Дейлом и Патриком Лэдлоу в 1910–1927 годах (Нобелевская премия 1936 года за исследования [медиаторов](/wiki/mediatory-nervnoy-sistemy)).

В чистом виде представляет собой бесцветные гигроскопичные кристаллы с температурой плавления 83–84 °C, хорошо растворимые в воде, этаноле и хлороформе. В физиологических условиях (pH 7,4) гистамин существует преимущественно в форме монопротонированного катиона (имидазолиевое кольцо протонировано, pKa ≈ 9,4 для аминогруппы и 6,0 для имидазольного азота), что определяет его взаимодействие с [гистаминовыми рецепторами](/wiki/gistaminovye-retseptory).

## Биосинтез и метаболизм

### Синтез

Гистамин образуется в результате декарбоксилирования L-гистидина под действием фермента [Гистидиндекарбоксилаза](/wiki/gistidindekarboksilaza) (HDC, КФ 4.1.1.22). Реакция требует наличия пиридоксаль-5'-фосфата (активной формы [витамина B6](/wiki/vitamin-b6)) в качестве кофермента.
...
- **Энтерохромаффиноподобные клетки (ECL-клетки)** желудка — основной источник гистамина для стимуляции [париетальных клеток](/wiki/parietalnye-kletki).
...
1. **Окислительное дезаминирование** — под действием [диаминоксидазы](/wiki/diaminoksidaza) (DAO, гистаминазы) с образованием имидазолуксусного альдегида, который далее окисляется до имидазолуксусной кислоты (выводится с мочой). DAO присутствует в тонком кишечнике, почках, плаценте и лейкоцитах.
2. **N-метилирование** — под действием [гистамин-N-метилтрансферазы](/wiki/gistamin-n-metiltransferaza) (HNMT) с использованием S-аденозилметионина (SAM) в качестве донора метильной группы. Продукт — N-метилгистамин, который затем окисляется моноаминоксидазой Б (MAO-B) до N-метилимидазолуксусной кислоты. HNMT локализуется преимущественно в цитозоле клеток (особенно в бронхах и ЦНС).
...
Гистамин — главный медиатор [анафилаксии](/wiki/anafilaksiya) и [аллергических реакций](/wiki/allergiya) I типа. При связывании аллергена с IgE на поверхности тучных клеток происходит дегрануляция с выбросом гистамина (концентрация в очаге достигает 10⁻⁵–10⁻⁴ М). Клинические проявления:
- [Крапивница](/wiki/krapivnitsa) — зудящие волдыри.
- [Ангионевротический отёк](/wiki/angionevroticheskiy-otek) (отёк Квинке) — глубокие слои дермы и подкожной клетчатки.
- [Аллергический ринит](/wiki/allergicheskiy-rinit) — чихание, ринорея, заложенность носа.
- [Бронхиальная астма](/wiki/bronhialnaya-astma) — бронхоспазм, гиперсекреция слизи.
- [Анафилактический шок](/wiki/anafilakticheskiy-shok) — системная вазодилатация, гипотензия, бронхоспазм, отёк гортани.

### Псевдоаллергические реакции

Пищевая непереносимость гистамина (гистаминоз) развивается при:
- Дефиците [DAO](/wiki/diaminoksidaza) (генетические полиморфизмы, приём ингибиторов — алкоголь, изониазид, хлорохин).
...
Гиперпродукция гистамина ECL-клетками (например, при гастриноме — [Синдром Золлингера-Эллисона](/wiki/sindrom-zollingera-ellisona)) приводит к гиперсекреции соляной кислоты и пептическим язвам. Антагонисты H₂-рецепторов (циметидин, ранитидин, фамотидин) остаются стандартом терапии.
...
- [Серотонин](/wiki/serotonin) — синергизм в регуляции тонуса сосудов и перистальтики.
- [Ацетилхолин](/wiki/atsetilholin) — антагонизм в бронхах (гистамин — бронхоконстриктор, ацетилхолин — также), синергизм в желудочной секреции.
- [Простагландины](/wiki/prostaglandiny) — потенцирование вазодилатации и отёка.
- [Лейкотриены](/wiki/leykotrieny) — совместное участие в поздней фазе аллергической реакции.
- [Цитокины](/wiki/tsitokiny) (IL-4, IL-13) — взаимная регуляция в Th2-иммунном ответе.
