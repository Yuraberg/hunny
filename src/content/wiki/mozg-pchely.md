...
excerpt: "Мозг пчелы (лат. encaphalon) представляет собой центральный отдел нервной системы насекомого, выполняющий функции высшей интегративной деятельности. Несмотря на микроскопические размеры (объём ~1 м…"
draft: false
---
...
3. **Тритоцеребрум** (задний отдел) — иннервация ротового аппарата и связь с [Подглоточный ганглий](/wiki/podglotochnyy-gangliy).
...
- **Грибовидные тела** (corpora pedunculata) — парные структуры, являющиеся высшими ассоциативными центрами. Состоят из:
  ...
  В грибовидных телах сосредоточено около 340 000 нейронов (примерно 35% всех нейронов мозга). Эти структуры критически важны для [обучения](/wiki/obuchenie-pchel), памяти и пространственной ориентации.
...
- **Зрительные доли** (lobi optici) — латеральные выросты протоцеребрума, обрабатывающие визуальную информацию от [фасеточных глаз](/wiki/fasetochnye-glaza-pchely). Каждая доля содержит три нейропильных слоя: ламина, медулла, лобула.
...
Тритоцеребрум — наименьший отдел, обеспечивающий связь с висцеральной нервной системой и [подглоточным ганглием](/wiki/podglotochnyy-gangliy). Содержит моторные нейроны, иннервирующие мышцы ротового аппарата.
...
- **Октамин** — аналог норадреналина у беспозвоночных, критичен для [ассоциативного обучения](/wiki/obuchenie-pchel);
...
Каждая гломерула антеннальной доли получает конвергентный вход от рецепторов одного типа, создавая комбинаторную карту запахов. Пчелы способны различать сотни тысяч различных ароматов, включая феромоны [своей колонии](/wiki/medonosnaya-pchela).
...
- навигацию по [солнечному компасу](/wiki/solnechnyy-kompas);
- распознавание паттернов цветов;
- оценку расстояний при [танцевальной коммуникации](/wiki/tantsy-pchel).
