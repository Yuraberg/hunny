...
title: "Апитоксин"
category: "Термины"
excerpt: "Апитоксин (от лат. apis — пчела и греч. toxikon — яд) — сложный многокомпонентный биологический комплекс, вырабатываемый специализированными железами медоносной пчелы (Apis mellifera) и предназначе…"
draft: false
---
...
Биосинтез белковых компонентов осуществляется на рибосомах секреторных клеток с последующей посттрансляционной модификацией. Синтез пептидов, таких как [Мелиттин](/wiki/melittin), происходит через предшественник — промелиттин, который гидролизуется дипептидилпептидазой IV. Количество синтезируемого яда зависит от возраста особи, сезона, кормовой базы и генетических особенностей породы пчёл.
...
- **Пептид MCD** (мастоцит-дегранулирующий пептид, 1–2 %) — вызывает дегрануляцию тучных клеток, способствуя высвобождению [Гистамин](/wiki/gistamin)а.
...
- Биогенные амины: [Гистамин](/wiki/gistamin) (0,1–1,5 %), дофамин, норадреналин.
...
1. **Мембранотропное действие** — [Мелиттин](/wiki/melittin) и фосфолипаза A2 синергически разрушают клеточные мембраны. Мелиттин образует трансмембранные поры, вызывая осмотический лизис клеток, а фосфолипаза A2 гидролизует фосфолипиды, усиливая повреждение.
...
В рамках [апитерапии](/wiki/apiterapiya) апитоксин применяется при:
