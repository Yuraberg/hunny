---
title: "Коллапс пчелиных семей (CCD)"
category: "Болезни и вредители"
excerpt: "Коллапс пчелиных семей (Colony Collapse Disorder, CCD) — это феномен, при котором происходит массовое и быстрое исчезновение рабочих пчёл из улья, при наличии:"
draft: false
---
...
- **Коллапс пчелиных семей (Colony Collapse Disorder, CCD)** — это феномен, при котором происходит массовое и быстрое исчезновение рабочих пчёл из улья, при наличии:
  ...
  - Запасов корма ([мёда](/wiki/med) и [перги](/wiki/perga)), которые не разграбляются другими насекомыми и не поражаются вторичными вредителями в течение длительного времени.
...
- **Ключевые группы факторов**:
  ...
  - Паразиты ([клещ Varroa destructor](/wiki/varroatoz)).
  - Антропогенные химические стрессоры ([пестициды](/wiki/pestitsidy-i-pchely), фунгициды, инсектициды).
...
- **Медленное развитие вторичных инфекций** (плесневые грибы, [гнильцы](/wiki/gniltsovye-bolezni)) — улей остаётся "консервированным" в течение нескольких недель.
...
- Требуется интеграция [апитерапевтических](/wiki/apiterapiya) знаний (использование продуктов пчеловодства для укрепления иммунитета), агрономических практик и ветеринарного мониторинга.
