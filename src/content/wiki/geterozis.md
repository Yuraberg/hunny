...
excerpt: "Гетерозис (от греч. heteroiosis — изменение, превращение; также известен как гибридная сила, hybrid vigor) — это явление превосходства гибридов первого поколения (F₁) над обеими родительскими форма…"
draft: false
---
...
Гетерозис тесно связан с такими концепциями, как [Инбридинг](/wiki/inbriding), [Гомозиготность](/wiki/gomozigotnost), [Доминантность](/wiki/dominantnost), [Эпистаз](/wiki/epistaz), [Комбинационная изменчивость](/wiki/kombinatsionnaya-izmenchivost). Понимание гетерозиса необходимо для разработки стратегий [селекции](/wiki/selektsiya) и [генетической инженерии](/wiki/geneticheskaya-inzheneriya).
