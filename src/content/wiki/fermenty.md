...
title: "Ферменты"
category: "Термины"
excerpt: "Ферменты (от лат. fermentum — закваска), также известные как энзимы (от греч. ἐν-ζύμη — в дрожжах), — это белковые молекулы или комплексы белков с небелковыми компонентами, которые выполняют функци…"
draft: false
---
