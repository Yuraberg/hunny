...
excerpt: "Болезнь Альцгеймера (альцгеймеровская деменция, сенильная деменция альцгеймеровского типа) — хроническое прогрессирующее нейродегенеративное заболевание центральной нервной системы, характеризующее…"
draft: false
---
...
- [Деменция](/wiki/dementsiya)
- [Нейродегенеративные заболевания](/wiki/neyrodegenerativnye-zabolevaniya)
- [Холинергическая система](/wiki/holinergicheskaya-sistema)
- [Тау-белок](/wiki/tau-belok)
- [Гиппокамп](/wiki/gippokamp)
- [Ацетилхолинэстераза](/wiki/atsetilholinesteraza)
