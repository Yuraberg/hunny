---
title: "Полифлорный мёд"
category: "Сорта мёда"
excerpt: "Полифлорный мёд (от греч. polys — многий и лат. flos — цветок) — это натуральный пчелиный мёд, произведённый медоносными пчёлами (Apis mellifera) из нектара цветков двух и более видов медоносных ра…"
draft: false
---

## Определение и базовая характеристика

**Полифлорный мёд** (от греч. *polys* — многий и лат. *flos* — цветок) — это натуральный пчелиный мёд, произведённый медоносными пчёлами (*Apis mellifera*) из нектара цветков двух и более видов медоносных растений. В отличие от [монофлорных сортов](/wiki/monoflornyy-med), где доминирует один ботанический источник (например, [Липовый мёд](/wiki/lipovyy-med) или [Гречишный мёд](/wiki/grechishnyy-med)), полифлорный продукт представляет собой сложную многокомпонентную смесь, ботанический состав которой определяется фенологией цветения местной флоры и географическим положением пасеки.
...
- **Респираторные заболевания**: [Апитерапия](/wiki/apiterapiya) при фарингитах, ларингитах, бронхитах — смягчающее, антибактериальное, иммуностимулирующее действие.
...
- [Монофлорный мёд](/wiki/monoflornyy-med)
- [Липовый мёд](/wiki/lipovyy-med)
