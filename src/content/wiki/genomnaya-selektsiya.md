---
title: "Геномная селекция"
category: "Наука и стандарты"
excerpt: "Геномная селекция (Genomic Selection, GS) — это метод маркер-ассоциированной селекции, при котором оценка племенной ценности (геномного прогноза) особи производится на основе одновременного анализа…"
draft: false
---
...
- **2015-2023 годы** — развитие методов одноклеточного секвенирования и интеграция с [CRISPR/Cas9](/wiki/crispr-cas9)
...
- Использование данных [Экспрессия генов](/wiki/ekspressiya-genov) для взвешивания маркеров
- Модели с интегрированием [эпигенетических](/wiki/epigenetika) модификаций
...
- Контроль [инбридинга](/wiki/inbriding) через ограничение родства отобранных особей
...
4. **Учёт [аддитивной генетической дисперсии](/wiki/additivnaya-geneticheskaya-dispersiya)** в полном объёме
...
5. **Неучёт [генотип-средовых взаимодействий](/wiki/genotip-sredovaya-vzaimosvyaz)** — при переносе модели в другие условия точность снижается
...
- **Интеграция с [генетическими маркерами](/wiki/geneticheskiy-marker) для устойчивости к РРСС (репродуктивно-респираторному синдрому)**
...
- **Интеграция с [транскриптомными](/wiki/transkriptomika) данными для улучшения точности
...
- **Геномная селекция в [гетерозисной](/wiki/geterozis) селекции** — прогноз комбинационной способности
...
- **Использование**: [Фармакогеномика](/wiki/farmakogenomika), прогноз риска диабета 2 типа, сердечно-сосудистых заболеваний, онкологических патологий
...
- **Изучение [микроэволюционных](/wiki/mikroevolyutsiya) процессов** — анализ динамики аллельных частот
...
- **Геном-транскриптомные модели** — использование [экспрессии генов](/wiki/ekspressiya-genov) как промежуточного фенотипа
- **Интеграция [метаболомики](/wiki/metabolomika) и [протеомики](/wiki/proteomika)** — учёт физиологического состояния
- **[Эпигенетические](/wiki/epigenetika) маркеры** — включение метилирования ДНК в модели прогноза
...
- **Модели с учётом [плейотропии](/wiki/pleyotropiya)** — совместный анализ множества признаков
...
- **[CRISPR/Cas9](/wiki/crispr-cas9) и геномная селекция** — интеграция редактирования генома с GS
...
- **Селекция по [гаплотипам](/wiki/gaplotip)** — использование блоков LD вместо отдельных маркеров
...
- [Маркер-ассоциированная селекция](/wiki/marker-assotsiirovannaya-selektsiya)
- [Количественная генетика](/wiki/kolichestvennaya-genetika)
- [Неравновесное сцепление](/wiki/neravnovesnoe-stseplenie)
- [Племенная ценность](/wiki/plemennaya-tsennost)
- [Генетический маркер](/wiki/geneticheskiy-marker)
- [Полногеномный поиск ассоциаций](/wiki/polnogenomnyy-poisk-assotsiatsiy)
- [Инбридинг](/wiki/inbriding)
