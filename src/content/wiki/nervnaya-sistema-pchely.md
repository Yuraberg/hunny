---
title: "Нервная система пчелы"
category: "Анатомия и физиология"
excerpt: "Нервная система медоносной пчелы (Apis mellifera) представляет собой одну из наиболее совершенных и специализированных нервных систем среди всех беспозвоночных животных. Являясь представителем отря…"
draft: false
---
...
С эволюционной точки зрения нервная система пчелы представляет собой вершину развития членистоногих, демонстрируя конвергентное сходство с нервными системами позвоночных в механизмах обработки сенсорной информации, что делает её ценнейшей моделью в [нейробиологии](/wiki/neyrobiologiya).
...
— Иннервирует мышцы глотки, участвует в контроле приёма пищи ([Нектар](/wiki/nektar)).
...
— Моторной активностью ротовых конечностей (мандибулы, максиллы, лабиум), критичной для воскостроения, кормления расплода и обработки [мёда](/wiki/med);
— Слюнными железами;
...
- **Абдоминальные ганглии**: у пчелы всего 4 абдоминальных ганглия (вместо 7 примитивных), контролирующих дыхательные движения, деятельность [жалящего аппарата](/wiki/zhalyaschiy-apparat), внутренних органов и мышц брюшка.
...
- Ключевую роль играют специфические рецепторы к [феромонам](/wiki/feromony-pchel): например, рецептор AmOR11 специфичен к компоненту маточного вещества 9-оксо-2-деценовой кислоте (9-ODA).
...
- Лабиальном щупике и глоссе (определение концентрации сахаров в [нектаре](/wiki/nektar));
...
- [Терморегуляции гнезда](/wiki/termoregulyatsiya-ulya) (поддержание 35°C в расплодной зоне);
...
- **Аллатостатины и аллатотропины** — регулируют синтез ювенильного гормона, контролирующего кастовую дифференциацию и [возрастной полиморфизм](/wiki/zhiznennyy-tsikl-pchelinoy-semi);
...
- **Социальное обучение** — передача информации о локации корма через [танцевальную коммуникацию](/wiki/tantsy-pchel).
...
- **Клещ [Варроа](/wiki/varroa)** — переносит вирусы (DWV), вызывающие деформацию крыльев и нейродегенеративные изменения.
